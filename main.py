...
if __name__ == "__main__":
    ...
    for privatekey in keys_list:
        ...
        # который выдает каждый фрагмент по одному за раз. Затем генератор преобразуется в список с помощью функции list()
        # и сохраняется в переменной done.
        ...
        for swap in done[0]:
            ...
            # Таким образом, этот фрагмент кода генерирует случайное целое число (random_amount) от 6 до 9,
            # а затем генерирует случайное число с плавающей запятой (amount_to_swap) от 0,000001 до 0,000009 (включительно).
            # Число с плавающей запятой округляется до десятичной точности, определяемой random_amount.
            random_amount = random.randint(6, 9)
